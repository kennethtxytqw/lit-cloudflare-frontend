import { AutoNetworkConfigs, CryptoRecords, DnsRecord, DnsRecordType, EthersProvider, NamehashOptions, NamingServiceName, Provider, ResolutionMethod, SourceConfig, Web3Version0Provider, Web3Version1Provider, TokenUriMetadata, DomainLocation } from './types/publicTypes';
/**
...
export default class Resolution {
     ...
     */
    static fromResolutionProvider(provider: Provider, networks: {
        ens?: {
            network: string;
        };
        uns?: {
     ...
     * @see https://eips.ethereum.org/EIPS/eip-1193
     */
    static fromEthereumEip1193Provider(provider: Provider, networks?: {
        ens?: {
            network: string;
        };
        uns?: {
     ...
     * @returns Registry contract address
     */
    location(domain: string): Promise<DomainLocation>;
